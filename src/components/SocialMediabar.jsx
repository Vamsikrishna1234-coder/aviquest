...
const SocialSidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-1/2 -translate-y-1/3 z-50 
                    hidden md:flex flex-col gap-3"> 
      {/* HIDDEN ON MOBILE — SHOW ONLY FROM md AND ABOVE */}
        ...
        <div key={index} className="group relative">
          ...
          <div
            className="
              ...
              text-sm group-hover:w-40 group-hover:pr-4 shadow-xl 
          ...
          >
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-0 h-0 
              border-t-8 border-b-8 border-l-8 border-t-transparent 
              border-b-transparent border-l-white translate-x-full">
            </div>
          </div>
          ...
          <a
            ...
            className={`
              ${item.color} text-white block rounded-r-lg shadow-xl 
              transition-all duration-300 p-2 
              group-hover:translate-x-32 hover:!translate-x-36
            `}
          >
